...
namespace KURS_OII
{
    public partial class Form1 : Form
    {
       public string directoryname = null;
        ...
        public void загрузитьБазуЗнанийToolStripMenuItem_Click(object sender, EventArgs e)
        {
            load();
        }
        ...
        {
            richTextBox5.Text = File.ReadAllText(directoryname + @"\p.txt");   //изменяем вероятности на первоначальные
            q_number = -1;
